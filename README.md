...
예전 FirstLotto 백업 HTML·CSS는 Git 기록에 보존되어 있으며, 깨진 페이지로 공개되지 않도록 현재 배포 파일에서는 제거했습니다.
...
1. FirstLotto 수정은 저장소 최상위 파일에서 합니다.

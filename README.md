...
`v32`, `v34`, `v35`는 GitHub의 배포 번호가 아닙니다. 아이폰이 최신 파일을 받도록 `main.js?v=35`처럼 파일 주소 뒤에 붙인 **내부 캐시 버전**입니다. 따라서 GitHub의 Deployments 목록에서 `v35`라는 이름을 찾는 방식이 아닙니다.
...
| 앱 | 설명 | 실행하기 | 코드 위치 |
|---|---|---|---|
| 🎱 **FirstLott** | 오늘의 주제와 시간을 이용한 오락용 로또 번호 생성기 | [FirstLott 실행](https://vokim2503.github.io/) | [저장소 최상위 파일 보기](https://github.com/Vokim2503/vokim2503.github.io) |
...
- `main.js` — 번호 생성, 자동 5게임, 당첨번호 비교
- `guide.html` — 사용법·난수 한계·책임 있는 이용 안내
- `privacy.html` — 개인정보·쿠키·Google 서비스 안내
...
현재 Philosophy Roulette의 소스는 다음 폴더에 보존되어 있습니다. 애드센스 심사 중에는 FirstLott 탐색과 분리했습니다.
...
예전 FirstLott 백업 HTML·CSS는 Git 기록에 보존되어 있으며, 깨진 페이지로 공개되지 않도록 현재 배포 파일에서는 제거했습니다.
...
3. `philosophy`는 이전 버전이므로 수정하지 않습니다.
